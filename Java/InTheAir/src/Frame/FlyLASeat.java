...
public class FlyLASeat extends JPanel{
	...
	public FlyLASeat() {
		...
		String str = "LA 비행기 좌석 안내도";
		JLabel LA = new JLabel(str);
		LA.setBounds(125, 10, 600, 50);
		LA.setFont(new Font("나눔고딕코딩", Font.BOLD, 32));
		LA.setForeground(new Color(0xFAECC5));
		add(LA);
		...
		btnPay.addActionListener(new ActionListener() {
			@Override
			public void actionPerformed(ActionEvent e) {
				FlyFrameBase.getInstance(new FlypaymentLA());
			}
