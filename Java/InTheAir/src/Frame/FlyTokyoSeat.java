...
public class FlyTokyoSeat extends JPanel{
	...
	public FlyTokyoSeat() {
		...
		String str = "도쿄 비행기 좌석 안내도";
		JLabel Tokyo = new JLabel(str);
		Tokyo.setBounds(110, 10, 600, 50);
		Tokyo.setFont(new Font("나눔고딕코딩", Font.BOLD, 32));
		Tokyo.setForeground(new Color(0xFFFFFF));
		add(Tokyo);
		...
		btnPay.addActionListener(new ActionListener() {
			@Override
			public void actionPerformed(ActionEvent e) {
				FlyFrameBase.getInstance(new FlypaymentTokyo());
			}
