...
public class FlypaymentHawaii extends JPanel implements test1  {
    ...
    public String[][] arr1() {
    	String infodata[][] = {{"구간1","ICN 인천 T1 14:00 ","2021-08-15(일)","경유2","20h44m","A1","D281"},
				{"구간1","ICN 인천 T1 14:00 ","2021-08-15(일)","경유2","20h44m","A2","D281"},
				{"구간1","ICN 인천 T1 14:00 ","2021-08-15(일)","경유2","20h44m","A3","D281"}
		};
		
    	return infodata;
    }
	
	public FlypaymentHawaii() {
