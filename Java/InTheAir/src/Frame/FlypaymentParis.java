...
public class FlypaymentParis extends JPanel implements test1  {
    ...
    public String[][] arr1() {
		String infodata[][] = {{"구간1","ICN 인천 T1 14:00 ","2021-08-15(일)","직항","12h05m","A1","D281"},
				{"구간1","ICN 인천 T1 14:00 ","2021-08-15(일)","직항","12h05m","A2","D281"},
				{"구간1","ICN 인천 T1 14:00 ","2021-08-15(일)","직항","12h05m","A3","D281"}
		};
