...
public class PlaceDAO {
	...
	private void init() {
		...
		//도쿄
		list.add(new Place("도쿄", "신구의 조화가 절묘한 도시", "680,000 원", "추천 여행 기간 : 10월~11월", 
		...
		//오클랜드
		list.add(new Place("오클랜드", "북섬의 북단에 위치한 수많은 인종이 함께 어울려 사는 뉴질랜드의 최대 도시이며 경제 중심지", "1,670,000 원", 
		...
		//취리히
		list.add(new Place("취리히", "취리히는 스위스 최대의 도시이자 풍요롭고 활기찬 도시, 경제 문화의 중심이다.", "657,400 원", "추천 여행 기간 : "
				+"연중 내내", "여름은 더워도 습하지 않고 겨울에도 지나치게 춥지 않다. 기본적으로 여름에는 덥고 건조, 겨울에는 춥고 눈이 많이 오는 기후지만, "
						+"수시로 날씨가 바뀌기 때문에 그에 대비한 준비를 철저히 해야 한다."));
		
		//파리
		list.add(new Place("파리", "패션과 미식, 예술과 낭만이 있는 세계 문화의 중심지", "682,900 원", "추천 여행 기간 : 4월~5월 / 9월~10월", 
		...
		//하와이
		list.add(new Place("하와이", "미국의 50번째 주로 태평양의 낙원이라 일컬어진다.", "2,981,200 원", "추천 여행 기간 : 4월~6월", "하와이는 "
