...
public class FlyGuamSeat extends JPanel{
	...
	public FlyGuamSeat() {
		...
		String str = "괌 비행기 좌석 안내도";
		JLabel Guam = new JLabel(str);
		Guam.setBounds(110, 10, 600, 50);
		Guam.setFont(new Font("나눔고딕코딩", Font.BOLD, 32));
		add(Guam);
		...
		btnPay.addActionListener(new ActionListener() {
			@Override
			public void actionPerformed(ActionEvent e) {
				//FlyFrameBase.getInstance(new FlypaymentGuam());
			}
