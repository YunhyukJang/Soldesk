...
public class FlyBaliSeat extends JPanel{
	...
	public FlyBaliSeat() {
		...
		String str = "발리 비행기 좌석 안내도";
		JLabel Bali = new JLabel(str);
		Bali.setBounds(110, 10, 600, 50);
		Bali.setFont(new Font("나눔고딕코딩", Font.BOLD, 32));
		add(Bali);
		...
		btnPay.addActionListener(new ActionListener() {
			@Override
			public void actionPerformed(ActionEvent e) {
				//FlyFrameBase.getInstance(new FlypaymentBali());
			}
