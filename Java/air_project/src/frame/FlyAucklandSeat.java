...
public class FlyAucklandSeat extends JPanel{
	
	private Image backImg;
	public FlyAucklandSeat() {
		...
		String str = "오클랜드 비행기 좌석 안내도";
		JLabel Auckland = new JLabel(str);
		Auckland.setBounds(80, 10, 600, 50);
		Auckland.setFont(new Font("나눔고딕코딩", Font.BOLD, 32));
		add(Auckland);
		...
		btnPay.setBackground(new Color(0xF6F6F6));
		...
		btnPay.addActionListener(new ActionListener() {
			@Override
			public void actionPerformed(ActionEvent e) {
				//FlyFrameBase.getInstance(new FlypaymentAuckland());
			}
