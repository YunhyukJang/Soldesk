...
public class FlyParisSeat extends JPanel{
	...
	public FlyParisSeat() {
		...
		String str = "파리 비행기 좌석 안내도";
		JLabel Paris = new JLabel(str);
		Paris.setBounds(110, 10, 600, 50);
		Paris.setFont(new Font("나눔고딕코딩", Font.BOLD, 32));
		Paris.setForeground(new Color(0xFAECC5));
		add(Paris);
		...
		btnPay.addActionListener(new ActionListener() {
			@Override
			public void actionPerformed(ActionEvent e) {
				//FlyFrameBase.getInstance(new FlypaymentParis());
			}
