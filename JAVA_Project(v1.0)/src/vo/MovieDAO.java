...
public class MovieDAO {
	private static ArrayList<Movie> list; //영화 정보 리스트
	private static ArrayList<MyMovie> reserveList; //예매 정보 리스트
	...
	//작성한 후기를 등록
	public void inputReview(String mName, String rvName,String rvMsg, int scoreNum) {
		for(int i=0; i<list.size(); i++) {
